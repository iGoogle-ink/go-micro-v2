...
import (
	...
	"github.com/iGoogle-ink/go-micro-v2/config/source/env"
	"github.com/iGoogle-ink/go-micro-v2/config/source/file"
	"github.com/iGoogle-ink/go-micro-v2/config/source/memory"
)
